          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-7 text-fg-secondary sm:text-base">
                ...
                as <code className="mx-1 rounded bg-card-3 px-1.5 py-0.5 text-xs text-fg">/support?app=&lt;slug&gt;</code>
            ...
            <div className="surface-card bg-card-2/70 p-4 text-sm lg:max-w-sm">
              <p className="font-semibold text-fg">Simple App Support Instructions</p>
              <ol className="mt-2 space-y-2 text-fg-secondary">
                {hasApps ? (
                  <>
            ...
            <div className="space-y-6">
              <div className="surface-card bg-card-2/70 p-5 sm:p-6">
                ...
                <div className="mt-4 space-y-3">
                  {faqs.map((item) => (
                    <details key={item.question} className="surface-card rounded-xl p-4">
                      <summary className="cursor-pointer list-none pr-6 text-sm font-medium text-fg">
                        {item.question}
                      </summary>
                      <p className="mt-3 text-sm text-fg-secondary">{item.answer}</p>
                    </details>
                  ))}
                </div>
              </div>
