...
function buildMarkdownDoc(entry: CorporateTechFix): string {
  ...
  lines.push("");
  lines.push("> Generated by Corporate Tech Fixes Ticket Builder");
  lines.push("");
  lines.push("## Metadata");
  lines.push("");
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="mt-4 text-2xl font-semibold text-slate-900 dark:text-slate-100 sm:text-3xl">
              Create Corporate Tech Fixes Ticket Entries
            </h1>
          ...
          <div className="rounded-2xl border border-line/80 bg-slate-50/80 p-4 text-sm dark:border-slate-800 dark:bg-slate-900/80">
            ...
            <div className="mt-4 rounded-xl border border-line/80 bg-white/70 p-3 dark:border-slate-700 dark:bg-slate-950/50">
              ...
              <p className="mt-1 text-[11px] leading-5 text-slate-500 dark:text-slate-400">
                Sends this ticket to the Cloudflare Worker publish API, which commits
              ...
              {remotePublishState.status === "success" ? (
                <div className="mt-2 rounded-lg border border-emerald-200 bg-emerald-50 p-2.5 text-xs text-emerald-800 dark:border-emerald-900/60 dark:bg-emerald-950/30 dark:text-emerald-200">
                  <p>
                    {remotePublishState.replaced ? "Updated" : "Published"} site ticket:
